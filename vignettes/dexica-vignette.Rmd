...
Insert section on determining optimal parameters from the results of a DexBatch run.

# Outlook

The current version of the DEXICA package should still be considered a work-in-progress.  Additional features will be added to subsequent versions, these include:
